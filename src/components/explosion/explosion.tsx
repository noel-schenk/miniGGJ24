...
// const Explosion: FC<ExplosionProps> = () => {
//   useEffect(() => {
...
// 		if (document.body.animate as any)
...
// 		}
// 	}
// 	createParticles(kind: any,count : any,duration: any) {
...
//   div;
//   s;
// 	constructor(parent: { appendChild: (arg0: any) => void; },x: number,y: number,w: number,h: number,angle: number,distance = 1,className2 = "") {
// 		let width = `${w}em`,
// 			height = `${h}em`,
...
// 		};
// 	}
// 	runSequence(el: { animate: (arg0: any, arg1: { duration: number; easing: string; delay: number; }) => any; parentElement: { classList: any; }; remove: () => void; },keyframesArray: ({ opacity: number; transform: string; } | { opacity: number; transform?: undefined; })[] | ({ background: string; transform: string; } | { background: string; transform?: undefined; })[],duration = 1e3,easing = "linear",delay = 0) {
...
// 	constructor(parent: any,x: number,y: number,w: number,h: number,angle: number,distance: number | undefined,duration: number,easing: string | undefined) {
...
// 	constructor(parent: any,x: any,y: any,w: number,h: number,angle: number,distance: number | undefined,duration: number,easing: string | undefined) {
